      ...
      >
        ...
        >
          {cards.map((pos, i) => (
            <motion.div
              key={i}
              className="absolute left-1/2 top-1/2 w-[80px] h-[133px] md:w-[90px] md:h-[150px] cursor-pointer"
              style={{
                transformStyle: "preserve-3d",
                transform: `translate(-50%, -50%) translate3d(${pos.x}px, ${pos.y}px, 0) rotateX(-65deg) rotateZ(${-pos.rotateY}deg)`,
              }}
        ...
        <motion.div
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] pointer-events-none"
